...
class RedeNeural(Thread):
    ...
    def atualizaPesos(self, erro, alpha=0.01):
        ...
        for i in range(len(pesosPrimeiroNeuronioCamadaEntrada)):
            pesosPrimeiroNeuronioCamadaEntrada[i] = pesosPrimeiroNeuronioCamadaEntrada[i] + (alpha * self.entradas[i] * erro)

        for i in range(len(pesosSegundoNeuronioCamadaEntrada)):
            pesosSegundoNeuronioCamadaEntrada[i] = pesosSegundoNeuronioCamadaEntrada[i] + (alpha * self.entradas[i] * erro)
